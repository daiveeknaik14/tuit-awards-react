...
const Tuit = ({tuit, deleteTuit, likeTuit, dislikeTuit, awardTuit, findAwardsByTuit}) => {
...
return(
  ...
  <li className="p-2 ttr-tuit list-group-item d-flex rounded-0">
    ...
    <div className="w-100">
      ...
      <TuitStats tuit={tuit} likeTuit={likeTuit} dislikeTuit={dislikeTuit} awardTuit={awardTuit} findAwardsByTuit={findAwardsByTuit}/>
    </div>
  </li>
);
}
